...
const routerContentTemplate = `// Code generated by gooze-starter. DO NOT EDIT.
...
func (self *generator) GenRouter() (err error) {
	...
	for _, service := range self.services {
		...
		templateData.NowTime = time.Now().Format(time.DateTime)
		...
		for _, route := range service.Routes {
			routeData := RouteSpecTemplateData{
				...
				Path:            strings.ToLower(camelToKebab(route.Path)),
